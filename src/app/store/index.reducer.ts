...
export function indexReducer(state = initialState, action: any) {
    ...
    if (type === 'setMainLayout') {
        ...
        payload = payload; // animate_fadeIn, animatefadeInDown, animatefadeInUp, animatefadeInLeft, animatefadeInRight, animateslideInDown, animateslideInLeft, animateslideInRight, animate_zoomIn
